            ...
            <tr>
               ...
               <td> <span class="btn btn-danger waves-effect waves-light"> {{ round($item->due) }}</span> </td>
                <td>
                    ...
                    <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal" data-bs-target="#signup-modal" id="{{$item->id}}" onclick="orderDue(this.id)">Pay Due</button> 
                </td>
            </tr>
            @endforeach
        </tbody>
