...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Log In | Manage Duka</title>
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        ...
                                        <a href="index.html" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="{{asset('backendassets/images/logo-light.png')}}" alt="" height="22">
                                            </span>
                                        </a>
                                    </div>
                                </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <footer class="footer footer-alt">
            2023 - <script>document.write(new Date().getFullYear())</script> &copy; Manshop by <a href="" class="text-white-50">CypressIQ</a> 
        </footer>
